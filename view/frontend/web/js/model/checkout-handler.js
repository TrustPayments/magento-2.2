...
define([
	...
	'TrustPayments_Payment/js/model/default-checkout'
], function(
	_,
	quote,
	...
	return function(formId, isActive, loadPaymentForm){
		...
		if (require.specified('trustpayments_checkout_adapter')) {
			require(['trustpayments_checkout_adapter'], function(adapter){
