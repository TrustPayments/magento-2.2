 ...
 */
namespace TrustPayments\Payment\Plugin\Framework\App\Config\Initial;
...
use TrustPayments\Payment\Model\Config\Dom;
use TrustPayments\Payment\Model\Config\DomFactory;

/**
 * Interceptor to dynamically extend the initial configuration with the Trust Payments payment method data.
 */
class Converter
{
    ...
    private function getTemplate()
    {
        if ($this->template == null) {
            $templatePath = $this->moduleReader->getModuleDir(\Magento\Framework\Module\Dir::MODULE_ETC_DIR,
                'TrustPayments_Payment') . '/config-method-template.xml';
