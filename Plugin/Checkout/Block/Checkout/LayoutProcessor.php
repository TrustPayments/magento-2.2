 ...
 */
namespace TrustPayments\Payment\Plugin\Checkout\Block\Checkout;
...
/**
 * Interceptor to dynamically extend the layout configuration with the Trust Payments payment method data.
 */
class LayoutProcessor
{
    ...
    public function beforeProcess(\Magento\Checkout\Block\Checkout\LayoutProcessor $subject, $jsLayout)
    {
        ...
        if (isset(
            $jsLayout['components']['checkout']['children']['steps']['children']['billing-step']['children']['payment']['children']['renders']['children']['trustpayments_payment']['methods'])) {
            ...
            foreach ($configurations as $configuration) {
                $jsLayout['components']['checkout']['children']['steps']['children']['billing-step']['children']['payment']['children']['renders']['children']['trustpayments_payment']['methods']['trustpayments_payment_' .
