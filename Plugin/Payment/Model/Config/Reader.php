 ...
 */
namespace TrustPayments\Payment\Plugin\Payment\Model\Config;
...
/**
 * Interceptor to dynamically extend the payment configuration with the Trust Payments payment method data.
 */
class Reader
{
    ...
    {
        return 'trustpayments_payment_' . $configuration->getEntityId();
    }
