 ...
 */
namespace TrustPayments\Payment\Controller\Adminhtml\Customer;
...
/**
 * Backend controller action to delete Trust Payments tokens.
 */
class Token extends \Magento\Customer\Controller\Adminhtml\Index
{
    ...
    public function execute()
    {
        ...
        if ($customerId && $tokenId) {
            try {
                /** @var \TrustPayments\Payment\Model\TokenInfo $token */
