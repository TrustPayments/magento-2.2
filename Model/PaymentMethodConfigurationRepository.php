...
use TrustPayments\Payment\Api\Data\PaymentMethodConfigurationSearchResultsInterfaceFactory;
use TrustPayments\Payment\Model\ResourceModel\PaymentMethodConfiguration as PaymentMethodConfigurationResource;
use TrustPayments\Payment\Model\ResourceModel\PaymentMethodConfiguration\CollectionFactory as PaymentMethodConfigurationCollectionFactory;
...
class PaymentMethodConfigurationRepository implements PaymentMethodConfigurationRepositoryInterface
{
    ...
    {
        /** @var \TrustPayments\Payment\Model\ResourceModel\PaymentMethodConfiguration\Collection $collection */
        $collection = $this->paymentMethodConfigurationCollectionFactory->create();

        $this->collectionProcessor->process($searchCriteria, $collection);

        /** @var \TrustPayments\Payment\Api\Data\PaymentMethodConfigurationSearchResultsInterface $searchResults */
