 ...
 */
namespace TrustPayments\Payment\Model\Payment\Method;
...
use TrustPayments\Payment\Block\Method\Form;
use TrustPayments\Payment\Block\Method\Info;
...
/**
 * Trust Payments payment method adapter.
 */
class Adapter extends \Magento\Payment\Model\Method\Adapter
{

    const CAPTURE_INVOICE_REGISTRY_KEY = 'trustpayments_payment_capture_invoice';
    ...
    /**
     *
     * @var \TrustPayments\Payment\Model\PaymentMethodConfiguration
     */
     ...
     *
     * @return \TrustPayments\Payment\Model\PaymentMethodConfiguration
     */
    ...
    {
        $spaceViewId = $this->scopeConfig->getValue('trustpayments_payment/general/space_view_id');
