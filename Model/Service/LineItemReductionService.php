...
use TrustPayments\Payment\Helper\LineItemReduction as LineItemReductionHelper;
...
class LineItemReductionService
{
    ...
    {
        /** @var \TrustPayments\Sdk\Model\LineItem[] $baseLineItems */
        $baseLineItems = $this->getBaseLineItems($creditmemo->getOrder()
            ->getTrustpaymentsSpaceId(), $creditmemo->getOrder()
        ...
        $this->eventManager->dispatch('trustpayments_payment_convert_line_item_reductions',
            [
                'transport' => $transport,
