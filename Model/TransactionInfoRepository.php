...
use TrustPayments\Payment\Api\Data\TransactionInfoSearchResultsInterfaceFactory;
use TrustPayments\Payment\Model\ResourceModel\TransactionInfo as TransactionInfoResource;
use TrustPayments\Payment\Model\ResourceModel\TransactionInfo\CollectionFactory as TransactionInfoCollectionFactory;
...
class TransactionInfoRepository implements TransactionInfoRepositoryInterface
{
    ...
    {
        /** @var \TrustPayments\Payment\Model\ResourceModel\TransactionInfo\Collection $collection */
        $collection = $this->transactionInfoCollectionFactory->create();

        $this->collectionProcessor->process($searchCriteria, $collection);

        /** @var \TrustPayments\Payment\Api\Data\TransactionInfoSearchResultsInterface $searchResults */
