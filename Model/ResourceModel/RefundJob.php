 ...
 */
namespace TrustPayments\Payment\Model\ResourceModel;
...
class RefundJob extends AbstractDb
{
     ...
     * @var string
     */
    protected $_eventPrefix = 'trustpayments_payment_refund_job_resource';
    ...
    {
        $this->_init('trustpayments_payment_refund_job', 'entity_id');
    }
        ...
        if ($field == RefundJobInterface::REFUND) {
            ...
            if ($value) {
                ...
                $value = $this->objectSerializer->deserialize($rawValue,
                    '\TrustPayments\Sdk\Model\RefundCreate');
                if (empty($value)) {
