 ...
 */
namespace TrustPayments\Payment\Model\ResourceModel\PaymentMethodConfiguration;

use Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection;
use TrustPayments\Payment\Model\PaymentMethodConfiguration;
use TrustPayments\Payment\Model\ResourceModel\PaymentMethodConfiguration as ResourceModel;
...
class Collection extends AbstractCollection
{
     ...
     * @var string
     */
    protected $_eventPrefix = 'trustpayments_payment_method_configuration_resource_collection';
