...
use TrustPayments\Payment\Api\Data\TokenInfoSearchResultsInterfaceFactory;
use TrustPayments\Payment\Model\ResourceModel\TokenInfo as TokenInfoResource;
use TrustPayments\Payment\Model\ResourceModel\TokenInfo\CollectionFactory as TokenInfoCollectionFactory;
...
class TokenInfoRepository implements TokenInfoRepositoryInterface
{
    ...
    {
        /** @var \TrustPayments\Payment\Model\ResourceModel\TokenInfo\Collection $collection */
        $collection = $this->tokenInfoCollectionFactory->create();

        $this->collectionProcessor->process($searchCriteria, $collection);

        /** @var \TrustPayments\Payment\Api\Data\TokenInfoSearchResultsInterface $searchResults */
