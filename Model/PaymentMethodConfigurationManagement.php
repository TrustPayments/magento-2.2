...
class PaymentMethodConfigurationManagement implements PaymentMethodConfigurationManagementInterface
{
    ...
    {
        $this->configWriter->save('payment/trustpayments_payment_' . $configuration->getEntityId() . '/' . $key,
            $value, $scope, $scopeId);
    }
    ...
    private function hasConfigurationChanged(\TrustPayments\Sdk\Model\PaymentMethodConfiguration $configuration,
