...
class Info extends \Magento\Payment\Block\Info
{
    ...
    public function getInvoiceDownloadUrl()
    {
        ...
        return $this->$class_backend->getUrl('trustpayments_payment/order/downloadInvoice',
            [
    ...
    {
        $class_backend = $this->isHelperBackend();
        return $this->$class_backend->getUrl('trustpayments_payment/order/downloadRefund',
            [
