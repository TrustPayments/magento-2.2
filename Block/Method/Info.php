...
use TrustPayments\Payment\Helper\Document as DocumentHelper;
use TrustPayments\Payment\Helper\Locale as LocaleHelper;
use TrustPayments\Payment\Model\Provider\LabelDescriptorGroupProvider;
use TrustPayments\Payment\Model\Provider\LabelDescriptorProvider;
...
class Info extends \Magento\Payment\Block\Info
{
     ...
     * @var string
     */
    protected $_template = 'TrustPayments_Payment::payment/method/info.phtml';

    /**
     *
     * @var \TrustPayments\Payment\Model\TransactionInfo
     */
    private $transaction;
    ...
    /**
     * Gets the URL to the transaction detail view in Trust Payments.
     *
     * @return string
     */
    public function getTransactionUrl()
    {
        return \rtrim($this->_scopeConfig->getValue('trustpayments_payment/general/base_gateway_url'), '/') .
            '/s/' . $this->getTransaction()->getSpaceId() . '/payment/transaction/view/' .
            $this->getTransaction()->getTransactionId();
    }

    /**
     * Gets the URL to the customer detail view in Trust Payments.
     *
     * @return string
     */
     ...
     *
     * @return \TrustPayments\Payment\Model\TransactionInfo|false
     */
    ...
    {
        return $this->getUrl('trustpayments_payment/order/downloadInvoice',
            [
    ...
    {
        return $this->getUrl('trustpayments_payment/order/downloadPackingSlip',
            [
                'order_id' => $this->getTransaction()
                    ->getOrderId()
            ]);
    ...
    {
        return $this->getUrl('trustpayments_payment/order/downloadRefund',
            [
    ...
    public function isRefundDownloadAllowed()
    {
        ...
        if ($this->getTransaction() && $creditmemo != null && $creditmemo->getTrustpaymentsExternalId() != null) {
            $storeId = null;
            if ($this->getInfo() instanceof Payment) {
                /** @var Payment $payment */
                $payment = $this->getInfo();
