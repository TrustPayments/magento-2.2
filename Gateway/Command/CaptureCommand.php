...
use TrustPayments\Payment\Model\Service\Invoice\TransactionService as InvoiceTransactionService;
...
class CaptureCommand implements CommandInterface
{
    ...
    public function execute(array $commandSubject)
    {
        ...
        if ($invoice->getTrustpaymentsCapturePending() || $this->isTransactionInvoiceOpen($invoice)) {
