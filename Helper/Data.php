...
use TrustPayments\Payment\Model\Provider\CurrencyProvider;
...
class Data extends AbstractHelper
{
    ...
    /**
     * Gets the URL to a resource on Trust Payments in the given context (space, space view, language).
     *
     * @param string $path
    ...
    {
        $url = \rtrim($this->scopeConfig->getValue('trustpayments_payment/general/base_gateway_url'), '/');
        if (! empty($language)) {
